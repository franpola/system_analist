# Incidencia 1560116
Perdida de conectividad con rpae en pre
...
Bien desde el navegador o con un curl

Pendiente de ver si se puede abrir la web desde el servidor directamente sin pasar por balanceador o con el resto de URLs disponibles publicadas
